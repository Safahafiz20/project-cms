			...
			<div class="row">
				...
				<div class="col-lg-4 col-md- mb-2">
					<div class="rent-item mb-4">
						<img style="height:250px;" class="img-fluid" src="<?=base_url('assets/upload/konten/' . $aa['foto'])?>" alt="">
						<h4 class="text-uppercase mb-4"><?= $aa['judul']?></h4>
						<h4 class="text-uppercase mb-4">Rp. <?= $aa['harga']?></h4>
						
						
						<a class="btn btn-primary px-3" href="<?=base_url('home/artikel/' . $aa['slug'])?>">Detail</a>
					</div>
				</div>			
				<?php }?>
			</div>
			...
			<div class="row mx-0">
				<div class="col-lg-6 px-0">
					<div class="px-5 bg-secondary d-flex align-items-center justify-content-between"
						...
						<div class="text-right">
							<h3 class="text-uppercase text-light mb-3">Ingin Membeli Motor impian?</h3>
							<p class="mb-4">Silahkan Hubungi dan Datang ke Showroom Kami</p>
				...
				<div class="col-lg-6 px-0">
					<div class="px-5 bg-dark d-flex align-items-center justify-content-between" style="height: 350px;">
						<div class="text-left">
							<h3 class="text-uppercase text-light mb-3">Melihat Motor Impian?</h3>
							<p class="mb-4">Silahkan Datang ke Showroom Kami</p>
		...
		<div class="row pt-5">
			<div class="col-lg-3 col-md-6 mb-5">
				...
				<div class="d-flex justify-content-start">
					<a class="btn btn-lg btn-dark btn-lg-square mr-2" href="<?= $konfig->facebook;?>"><i class="fab fa-facebook-f"></i></a>
					<a class="btn btn-lg btn-dark btn-lg-square" href="<?= $konfig->instagram;?>"><i class="fab fa-instagram"></i></a>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-5">
				...
				<?php foreach ($kategori as $kate) { ?>
					<a class="text-body mb-2" href="<?= base_url('home/kategori/'.$kate['id_kategori'])?>"><i class="fa fa-angle-right text-white mr-2"></i><?= $kate['nama_kategori']?>
					</a>
					<?php }?>
